                    ...
                    <button class="bg-transparent border-0 inline-flex flex-col gap-2" 
                      ...
                      <span :class="[
                        ...
                        { 'bg-primary text-primary-contrast border-primary': value <= currentStep, 
                          'border-surface-200 dark:border-surface-700': value > currentStep }
                      ]">
                        <i class="pi pi-user" />
                      </span>
                    </button>
              ...
              <StepPanels>
                ...
                <StepPanel v-slot="{ activateCallback }" :value="3">
                  ...
                  <div class="flex pt-6 justify-between">
                    ...
                    />
                    <Button 
                      :label="isProcessingPayment ? t('checkout.payment.processing') : t('checkout.payment.pay')"
                      :icon="isProcessingPayment ? 'pi pi-spinner pi-spin' : 'pi pi-credit-card'"
                      :severity="isProcessingPayment ? 'secondary' : 'primary'"
                      iconPos="right"
                      :disabled="!isStepValid || isProcessingPayment || !canMoveToStep(4)"
                      @click="async () => {
